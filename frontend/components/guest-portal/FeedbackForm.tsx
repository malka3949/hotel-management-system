...
export default function FeedbackForm({ token }: Props) {
  ...
  return (
    <div className="bg-white border border-[#E5DFDA] rounded-xl p-6 mt-6" dir="rtl">
      ...
      <textarea
        ...
        rows={3}
        className="w-full border border-[#E5DFDA] rounded-lg p-3 text-sm text-[#0F172A] resize-none focus:outline-none focus:ring-2 focus:ring-[#C4A253]"
      />
