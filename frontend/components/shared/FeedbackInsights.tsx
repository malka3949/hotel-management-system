  ...
  return (
    <div dir="rtl" className="space-y-4">
      ...
      <div className="bg-[var(--color-bg-surface)] border border-[var(--color-border-default)] rounded-xl p-4">
        <h4 className="text-sm font-semibold text-[var(--color-text-primary)] mb-3">ביקורות אחרונות</h4>
        <div className="space-y-3">
          {data.recent.map((f, i) => (
            <div key={i} className="border-b border-[var(--color-border-default)] pb-3 last:border-0 last:pb-0">
